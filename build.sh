#!/bin/bash -e
# Vendored from nwjs-ffmpeg-prebuilt/nwjs-ffmpeg-prebuilt build.sh
# Snapshot: 8958574124124c4738dedf81a69b0819e63e3c08
...
osx-arm64) ffbuild="--arch=arm64 --disable-decoder=h264" ;;
